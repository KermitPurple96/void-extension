...
test.describe('Void Extension AI Pentest', () => {
  ...
  test('VOID_SKILLS=55', async () => { expect(await page.evaluate(() => Object.keys(window.VOID_SKILLS||{}).length)).toBe(55); });
  ...
  test('UC: cleanup leaves no test entries behind', async () => {
    ...
    expect(await page.evaluate(() => Object.keys(window.VOID_SKILLS).length)).toBe(55);
  });
